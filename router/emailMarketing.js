...
router.post('/email-marketing', (req, res) => {
    try {
      ...
      const mailOptions = {
        ...
        to: email,
        subject: `Chào mừng ${name} đã đến với học viện ALP`,
														...
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-top:5px;width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 200px;"><img src="https://w.ladicdn.com/s400x400/5ebf76b51e398e6f1670261b/chia-khoa-trang-tach-nen-20230714140702-w8nf5.png" style="display: block; height: auto; border: 0; width: 100%;" width="106" alt="Your Logo" title="Your Logo" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
